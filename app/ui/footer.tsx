...
export function Footer({ footerNav }: FooterProps) {
  ...
  return (
    <div className={styles.footer}>
      <div className={styles.footerTop}>
        ...
        <div>
          <a href={footerNav.socialLinks.instagramUrl} target='_blank' rel='noreferrer'>
            Instagram
          </a>
          <a href={footerNav.socialLinks.twitterUrl} target='_blank' rel='noreferrer'>
            Twitter
          </a>
          <a href={footerNav.socialLinks.facebookUrl} target='_blank' rel='noreferrer'>
            Facebook
          </a>
          <a href={footerNav.socialLinks.youtubeUrl} target='_blank' rel='noreferrer'>
            Youtube
          </a>
        </div>
        {!isMobile && (
